...
public class DessertActivity extends AppCompatActivity {
    ...
    private ProductsAdapter dessertAdapter;
    private List<Products> dessertList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dessertAdapter = new ProductsAdapter(dessertList);
...
//
//        });
        StringRequest getDessert = new StringRequest(Request.Method.POST, Config.GET_FOOD_URL, new Response.Listener<String>() {
            @Override
...
//                        dessertList.add(makanan);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(DessertActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        getDessert.setRetryPolicy(new RetryPolicy() {
            @Override
